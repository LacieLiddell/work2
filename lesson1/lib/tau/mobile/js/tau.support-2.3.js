...
(function (document, ns) {
	"use strict";
			...
			*/
			...
			engine.defineWidget(
				"Checkboxradio",
				"input[type='checkbox']:not(.slider-switch-input):not([data-role='toggleswitch']):not(.toggleswitch), " +
				"input[type='radio'], " +
				"input.checkbox, " +
				"input.radio",
				[],
...
(function (document, ns) {
	"use strict";
				...
				themes = ns.theme,
				/**
				 * @property {Object} selectors Alias for data-role ns.util.selectors
				 * @member ns.widget.mobile.ToggleSwitchExtra
				 * @private
				 * @static
				 */
				...
				classes = {
					...
					toggleInneroffset: "slider-inneroffset",
					sliderInline: "slider-inline",
					sliderMini: "slider-mini",
					sliderHandle: "slider-handle",
					flipHandle: "flip-handle",
					slider: "slider",
					sliderLabel: "slider-label",
					sliderLabelTheme: "slider-label-",
					sliderInneroffset: "slider-inneroffset",
					sliderLabelA: "slider-label-a",
					sliderSnapping : "slider-handle-snapping",
					//sliderBg: "slider-bg",
					sliderContainer: "slider-container",
					sliderStateActive: "state-active"
				},
				keyCode = {
					HOME: 36,
					END: 35,
			...
			/**
			 * Dictionary for ToggleSwitchExtra related css data-role names
			...
			/**
			 * Refresh widget and add css data-role
			 * @method onTouchend
			 * @param {ns.widget.mobile.ToggleSwitchExtra} self
			 * @private
			 * @static
 ...
 *
 * @data-role ns.widget.mobile.SelectMenu
 ...
 *  - HTML elements with data-role progress
 *
 * ###HTML Examples
 *
 ...
 * @data-role ns.widget.mobile.Progress
 */
...
(function (document, ns) {
	"use strict";
			...
			var ProgressExtra = ns.widget.core.progress.Progress,
				/**
				 * @property {ns.engine} engine Alias for data-role ns.engine
				 * @member ns.widget.mobile.Progress
				 * @private
				 * @static
				 */
				...
				classes = {
					uiProgressPendingRunning: "progress-pending-running"
				};
 ...
 *  - HTML elements with data-role progressbar
 *
 * ###HTML Examples
 *
 * ####Create simple text input on INPUT element
 ...
 *
 * @extends ns.widget.BaseWidget
 * @data-role ns.widget.mobile.ProgressBar
 */
...
(function (document, ns) {
	"use strict";
			...
			/**
			 * Dictionary for progress related css data-role names
			 * @property {Object} classes
			 * @static
			 * @member ns.widget.mobile.ProgressBar
			 * @readonly
			...
			ProgressBar.classes = {
				...
				uiProgressbarBg: "progressbar-bg",
				uiProgressbarValue: "progressbar-value"
			};
 ...
 *
 * Additionaly all UL or OL elements with data-role _ui-listview_ are changed to
 *  Tizen Web UI Listview.
 *
 *		@example
 ...
 *			<li><a href="#">
 *				Anton
 *				<span data-role="li-text-sub">subtext</span>
 *				</a>
 *			</li>
 *			<li><a href="#">
 *				Barry
 ...
 *		@example
 *		<ul data-role="listview">
 *			<li data-role="li-multiline">Anton
 *				<span data-role="li-text-sub">subtext</span>
 *			</li>
 *			<li data-role="li-multiline">Barry
 *				<span data-role="li-text-sub">subtext</span>
 *			</li>
 *			<li data-role="li-multiline">Bill
 *				<span data-role="li-text-sub">subtext</span>
 *			</li>
 *		</ul>
 *
 ...
 *		@example
 *		<ul data-role="listview">
 *			<li><img src="a.jpg" data-role="li-bigicon" />Anton</li>
 *			<li><img src="a.jpg" data-role="li-bigicon" />Barry</li>
 *			<li><img src="a.jpg" data-role="li-bigicon" />Bill</li>
 *		</ul>
 *
 ...
 *		@example
 *		<ul data-role="listview">
 *			<li data-role="li-thumbnail-right">
 *				<img src="a.jpg" data-role="li-bigicon" />
 *				Anton
 *			</li>
 *			<li data-role="li-thumbnail-right">
 *				<img src="a.jpg" data-role="li-bigicon" />
 ...
 *		<ul data-role="listview">
 *			<li><a href="#">
 *					<img src="thumbnail.jpg" data-role="li-bigicon" />
 *					Anton
 *				</a>
 *			</li>
 *			<li><a href="#">
 ...
 *					Anton
 *					<span data-role="li-text-sub">subtext</span>
 *					<span data-role="li-text-sub2">subtext 2</span>
 *				</a>
 *			</li>
 *			<li data-role="li-has-multiline">
 *				<a href="#">
 ...
 *						<img data-role= "li-icon-sub-right"
 ...
 *				<a href="#">
 *					Barry
 *					<span data-role="li-text-sub">
 *						<img data-role="li-icon-sub"
 *							src="00_winset_icon_favorite_on.png" />
 *						subtext
 *					</span>
 *					<span>
 ...
 *					<img src="thumbnail.jpg" data-role="li-bigicon" />
 *					Barry
 *					<span data-role="li-text-sub">subtext 1</span>
 *					<span data-role="li-text-sub2">subtext 2</span>
 *				</a>
 *			</li>
 *		</ul>
 ...
 *			<li data-role="li-has-multiline">
 *				<a href="#">
 *					<span data-role="li-color-bar"
 *						style="background-color: red;"></span>
 *					Anton
 *					<span data-role="li-text-sub">subtext
 ...
 *		@example
 *		<ul data-role="listview">
 *			<li data-role="li-has-multiline li-thumbnail-right">
 *				<a href="#">
 *					Anton
 *					<span data-role="li-text-sub">subtext</span>
 *					<img src="thumbnail.jpg" data-role="li-bigicon">
 ...
 *			<li data-role="li-has-multiline">
 *				<a href="#">
 *					<img scr="thumbnail.jpg" data-role="li-bigicon">
 *					Anton
 *					<span data-role="li-text-sub">subtext</span>
 ...
 *		</ul>
 *
 * @data-role ns.widget.mobile.ListviewExtra
...
(function (window, document, ns) {
	"use strict";
				...
				/**
				 * Alias for data-role {@link ns.engine}
				...
				engine = ns.engine,
				/**
				 * Alias for data-role {@link ns.util.DOM}
				 * @property {Object} DOM
				 * @member ns.widget.mobile.ListviewExtra
				 * @private
				 * @static
				 ...
				 * @private
				 * @readonly
				 * @property {string} classes.uiListview Main data-role of listview
				 * @property {string} classes.uiLinkInherit data-role inherit link on listview
				 * @property {string} classes.uiLiThumb data-role of thumb included in li element
				 * @property {string} classes.uiLiHasThumb data-role of li element which has thumb
				 * @property {string} classes.uiLiIcon data-role of icon included in li element
				 * @property {string} classes.uiLiHasIcon data-role of li element which has icon
				 * @property {string} classes.uiLiHasCheckbox data-role of li element which has checkbox
				 * @property {string} classes.uiLiHasCheckboxDisabled data-role of li element which has checkbox disabled
				 * @property {string} classes.uiLiHasRadio data-role of li element which has radio button
				 * @property {string} classes.uiLiHasRadioDisabled data-role of li element which has radio button disabled
				 * @property {string} classes.uiLiHasRightCircleBtn data-role of li element which has circle button
				 * @property {string} classes.uiLiHasRightBtn data-role of li element which has button allign to right
				 * @property {string} classes.uiLiCount data-role of count included in li element
				 * @property {string} classes.uiLiHasCount data-role of li element which has count
				 * @property {string} classes.uiLiStatic data-role of li static element
				 * @property {string} classes.uiLiHeading data-role of li heading
				 */
				classes = {
					uiListview : "listview",
					uiLinkInherit: "link-inherit",
					uiLiThumb: "li-thumb",
					uiLiHasThumb: "li-has-thumb",
					uiLiIcon: "li-icon",
					uiLiHasIcon: "li-has-icon",
					uiLiHasCheckbox: "li-has-checkbox",
					uiLiHasCheckboxDisabled: "li-has-checkbox-disabled",
					uiLiHasRadio: "li-has-radio",
					uiLiHasRadioDisabled: "li-has-radio-disabled",
					uiLiHasRightCircleBtn: "li-has-right-circle-btn",
					uiLiHasRightBtn: "li-has-right-btn",
					uiLiCount: "li-count",
					uiLiHasCount: "li-has-count",
					uiLiAnchor: "li-anchor",
					uiLiStatic: "li-static",
					uiLiHeading: "li-heading"
				},
				/**
			...
			/**
			 * Function add li-heading data-role to all headings elemenets in list
			...
			ListviewExtra.prototype._clickCheckboxRadio = function (element) {
				var checkboxRadio = slice.call(element.querySelectorAll(".checkbox, .radio")),
 ...
 *			<li data-role="custom-data-role"></li>
 *		</ul>
 *
 *		<script>
 *			var config = {
 ...
 *			<li data-role="my-custom-data-role">${NAME}</li>
 *		</script>
 *
 *		<!-- Template for loader -->
 *		<script id="tmp_load_more" type="text/x-jquery-tmpl">
 *			<li data-role="my-custom-loader-data-role">
 ...
 *					listItem.classList.add('crazy-data-role');
 *				}
 *			}
 *			// Create widget using TAU notation ...
 ...
 *
 *
 * @data-role ns.widget.mobile.ExtendableList
 * @extends ns.widget.mobile.Listview
...
(function(document, ns) {
	"use strict";
			...
			var Listview = ns.widget.mobile.Listview,
				...
				/**
				 * @property {Object} engine Alias for data-role {@link ns.engine}
				 * @private
				 * @static
				 * @member ns.widget.mobile.ExtendableList
				 */
				...
				/**
				 * @property {Object} util Alias for data-role {@link ns.util}
				 * @private
				 * @static
				 * @member ns.widget.mobile.ExtendableList
				 */
				 ...
				 */
				classes = {
					CONTAINER: "extendable-list-container",
			...
			engine.defineWidget(
				"ExtendableList",
				"[data-role='extendablelist'], .extendablelist",
				["recreate", "create"],
				ExtendableList,
				"tizen"
			);
 ...
 *
 * ##Default selectors
 * In all elements with _data-role=notification_ or with _ui-notification_ CSS data-role. Use _p_ tag for messages and _img_ tag for icon.
 *
 * ##Manual constructor
 ...
 *		</script>
 *
 * @data-role ns.widget.mobile.Notification
...
(function (document, ns) {
	"use strict";
			...
			var BaseWidget = ns.widget.mobile.BaseWidgetMobile,
				...
				/**
				 * @property {Object} engine Alias for data-role ns.engine
				 * @member ns.widget.mobile.Notification
				 * @private
				 */
				engine = ns.engine,
				/**
				 * @property {Object} selectors Alias for data-role ns.selectors
				 * @member ns.widget.mobile.Notification
				 * @private
				 */
				selectors = ns.util.selectors,
				doms = ns.util.DOM,
				/**
				 * @property {Object} themes Alias for data-role ns.theme
				 * @member ns.widget.mobile.Notification
				 * @private
				 */
				themes = ns.theme,
				...
				/**
				 * Alias for data-role ns.widget.mobile.Notification
				 * @method Notification
				 * @member ns.widget.mobile.Notification
				 * @private
				 */
			...
			/**
			 * Dictionary for notification related css data-role names
			 * @property {Object} classes
			 * @member ns.widget.mobile.Notification
			 * @static
			 */
			Notification.classes = {
				uiTicker : "ticker",
				uiTickerText1Bg : "ticker-text1-bg",
				uiTickerText2Bg : "ticker-text2-bg",
				uiTickerIcon : "ticker-icon",
				uiSmallpopup : "smallpopup",
				uiSmallpopupTextBg : "smallpopup-text-bg",
				uiTickerBtn : "ticker-btn",
			...
			Notification.prototype._positionWidget = function () {
				...
				if (typeof pages[0] === "object") {
					footers = selectors.getChildrenByClass(pages[0], "footer");
			...
			engine.defineWidget(
				"Notification",
				"[data-role='notification'], .notification",
 ...
 * @data-role ns.widget.mobile.Listview.Autodividers
 * @since Tizen 2.0
			...
			*/
			var selectors = ns.util.selectors,
				...
				*/
				...
				/**
				* @property {Function} Listview Alias for data-role ns.widget.mobile.Listview
				* @member ns.widget.mobile.Listview.Autodividers
				* @static
				* @private
				*/
 ...
 *
 * @data-role ns.widget.mobile.GroupIndex
...
(function (document, ns) {
	"use strict";
				...
				classes = {
					uiBarThemePrefix: "bar-",
					uiLiDivider: "li-divider",
					uiDividerNormalLine: "divider-normal-line"
				},
			...
			ListDivider.prototype._build = function (element) {
				...
				if (!options.style || options.style === "normal" || options.style === "check") {
					DOM.wrapInHTML(
						element.childNodes,
						"<span data-role='divider-text'></span>"
					);
					...
					if (options.line === true) {
						...
						if (elementWithLine) {
							elementWithLine.insertAdjacentHTML(
								"beforeend",
								"<span data-role='" + classes.uiDividerNormalLine + "'></span>"
							);
						}
					}
				}
			...
			engine.defineWidget(
				"ListDivider",
				"[data-role='list-divider'], .list-divider",
				[],
				ListDivider,
				"mobile",
				true
 ...
 *
 * @data-role ns.widget.mobile.Collapsible
 * @author Hyeoncheol Choi <hc7.choi@samsung.com>
 */
(function (document, ns) {
	"use strict";
 ...
 *
 * ##Default selectors
 * In default all elements with _data-role="collapsible-set"_ or data-role _.collapsible-set_ are changed to collapsibleset widget.
 *
 * ##HTML Examples
 *
 ...
 *
 *
 * @data-role ns.widget.mobile.CollapsibleSet
 * @extends ns.widget.BaseWidget
...
(function (document, ns) {
	"use strict";
			...
			CollapsibleSet.classes = {
				...
				uiCollapsibleSet: "collapsible-set",
				uiCollapsibleHeading: Expandable.classes.uiExpandableHeading,
				uiCornerTop: "corner-top",
				uiCornerBottom: "corner-bottom",
			...
			prototype._refresh = function () {
				var element = this.element,
					...
					bareCollapsibles = selectors.getChildrenBySelector(element, ":not(.collapsible)"),
			...
			engine.defineWidget(
				"CollapsibleSet",
				"[data-role='collapsible-set'], .collapsible-set",
				[],
				CollapsibleSet,
				"mobile"
			);
 ...
 * Dialog.
 *
 * In additional all elements with data-role _ui-dialog_ are changed to Tizen Web UI
 * Dialog.
 *
 ...
 *		</div>
 *
 * #### Create simple dialog from div using data-role selector
 *
 *		@example
 *		<div data-role="page" id="page1">
 *			<div data-role="header">
 ...
 *		</div>
 *
 * @data-role ns.widget.mobile.Dialog
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
			...
			var BaseWidget = ns.widget.mobile.BaseWidgetMobile,
				...
				/**
				 * Dictionary for dialog related css data-role names
				 * @property {Object} classes
				 * @member ns.widget.mobile.Dialog
				 * @static
				 * @readonly
				 * @property {string} classes.uiDialog Main Dialog data-role name
				 * @property {string} classes.uiDialogContain
				 * Dialog container data-role name
				 ...
				 * data-role for all Dialog corners
				...
				classes = {
					uiDialog: "dialog",
					uiDialogContain: "dialog-contain",
					uiOverlayShadow: "overlay-shadow",
					uiOverlayPrefix: "overlay-",
					uiCornerAll: "corner-all",
					uiHeader: "header",
					uiContent: "content",
					uiFooter: "footer",
					uiBarPrefix: "bar-",
					uiBodyPrefix: "body-",
					uiDialogHidden: "dialog-hidden"
				},
			...
			*/
			...
			/**
			 * Handler function to add data-role on pagebeforeshow
...
/**
 * #Route Page
 * Support data-role for router to control changing pages in profile Wearable.
 * @data-role ns.router.route.page
...
(function (document, ns) {
	"use strict";
			...
			routeDialog.open = function (toPage, options) {
				...
				pageTitle = DOM.getNSData(toPage, "title") || utilSelector.getChildrenBySelector(toPage, ".header > .title").textContent || pageTitle;
 ...
 *
 * @data-role ns.widget.mobile.Slider
 * @author Hyeoncheol Choi <hc7.choi@samsung.com>
 */
(function (document, ns) {
	"use strict";
				...
				classes = object.merge({}, CoreSlider.classes, {
					...
					SLIDER_WITH_ICON: "slider-with-icon",
					SLIDER_TEXT_LEFT: "slider-text-left",
					SLIDER_TEXT_RIGHT: "slider-text-right",
					SLIDER_WITH_TEXT_LEFT: "slider-with-text-left",
					SLIDER_WITH_TEXT_RIGHT: "slider-with-text-right"
				}),
				prototype = new BaseWidget();
 ...
 *
 * ## Default selectors
 * All scrollview selectors with have a data-role _.scrollhandler_
 ...
 *		</div>
 *
 * #### Enhanced scrollview using css .scrollhandler data-role
 *
 *		@example
 *		<div data-role="page">
 *			<div data-role="content" data-role="scrollhandler">
 *				page content
 *			</div>
 *		</div>
 *
 ...
 *
 * @data-role ns.widget.mobile.ScrollHandler
...
(function (window, document, ns) {
	"use strict";
				 ...
				 * @property {Object} classes
				 * @property {string} [classes.handler="handler"] Handler main data-role
				 * @property {string} [classes.directionPrefix="handler-direction"] Direction data-role prefix
				 * @property {string} [classes.track="handler-track"] Handler track data-role
				 * @property {string} [classes.thumb="handler-thumb"] Handler thumb button prefix
				 * @property {string} [classes.themePrefix="handller-"] Handler theme data-role prefix
				 * @property {string} [classes.scrollbarDisabled="scrollbar-disabled"] Scrollview scrollbar disabled data-role
				 * @property {string} [classes.disabled="disabled"] Disabled data-role
				 * @property {string} [classes.hideNativeScrollbar="hide-scrollbar"] Hides native scrollbar in scrollview
				 * @member ns.widget.mobile.ScrollHandler
				 * @static
				 * @readonly
				 */
				classes = {
					handler: "handler",
					directionPrefix: "handler-direction-",
					track: "handler-track",
			...
			prototype._build = function (element) {
				...
				// .content.scrollview-clip.hide-scrollbar::-webkit-scrollbar
			...
			engine.defineWidget(
				"ScrollHandler",
				"[data-role='content'][data-handler='true']:not([data-scroll='none']):not(.scrollview-clip):not(.scrolllistview),[data-handler='true'], .scrollhandler",
				[
					"enableHandler",
					"scrollTo",
 ...
 *  - HTML elements with data-role searchbar
 *
 * ###HTML Examples
 *
 ...
 *
 * #Search Bar Widget
 * @data-role ns.widget.mobile.SearchBar
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
			var SearchBar = function () {
				...
				events = ns.event,
				classes = {
					uiInputText: "input-text",
					uiInputSearch: "input-search",
					uiShadowInset: "shadow-inset",
					uiCornerAll: "corner-all",
					uiBtnShadow: "btn-shadow",
					uiInputSearchDefault: "input-search-default",
					uiSearchBarIcon: "search-bar-icon",
					uiInputClear: "input-clear",
					uiInputClearHidden: "input-clear-hidden",
					inputSearchBar: "input-search-bar",
					uiInputCancel: "input-cancel",
					uiInputDefaultText: "input-default-text",
					uiBtnSearchFrontIcon: "btn-search-front-icon",
					uiInputSearchWide: "input-search-wide",
					uiBtnCancelHide: "btn-cancel-hide",
					uiBtnCancelShow: "btn-cancel-show",
					uiFocus: "focus",
					uiHeaderSearchBar: "header-searchbar",
					clearActive: "text-input-clear-active",
					textLine: "text-input-textline",
					uiSearchBarIconPositionLeft: "search-bar-icon-left",
					uiSearchBarIconPositionRight: "search-bar-icon-right"
				};

			SearchBar.prototype = new BaseWidget();

			/**
			 * Dictionary for SearchBar related css data-role names
			 * @property {Object} classes
			...
			SearchBar.prototype._build = function (element) {
				...
				if (element.parentNode.classList.contains("header")) {
			...
			engine.defineWidget(
				"SearchBar",
				"input[name='search'], div[data-type='search'], div[data-type='tizen-search'], .searchbar",
				[],
				SearchBar,
				"mobile"
			);
 ...
 *
 * ## Default selectors
 * All elements which have a data-role _.swipe_ or an attribute _data-role=swipe_
 ...
 *		</div>
 *
 * #### Create swipe widget using the data-role
 *
 *		@example
 *		<div id="swipe" data-role="swipe">
 *			<div data-role="swipe-item-cover">
 ...
 *
 *
 * @data-role ns.widget.mobile.Swipe
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
			...
			/**
			 * Dictionary for swipe related css data-role names
			 * @property {Object} classes
			 * @member ns.widget.mobile.Swipe
			 * @static
			 * @readonly
 ...
 *
 * @data-role ns.widget.mobile.TextInputExtra
...
(function (window, document, ns) {
    "use strict";
            ...
            engine.defineWidget(
                ...
                ", textarea" +
                ", input:not([type]):not([data-role]):not(.checkbox):not(.tizenslider)" +
                ", " + selector,
                ["getLabel", "setLabel"],
                TextInputExtra,
                "mobile"
...
/* Added to classes:
 *   + tokentextarea display flex
 *   + tokentextarea-input added flex
 *   + tokentextarea-span-block added flex
 *   + tokentextarea-desclabel added padding
 *
 * Delete from data-role:
 *   + tokentextarea-link-base deleted position
 *
 * Changed classes:
 *   + tokentextarea div to tokentextarea-span-block
 * Added data-role for hiding element:
 *   + span.tokentextarea-invisible
 *
 ...
 * @data-role ns.widget.mobile.TokenTextarea
 * @extends ns.widget.BaseWidget
 */
...
(function (window, ns) {
	"use strict";
			...
			var BaseWidget = ns.widget.mobile.BaseWidgetMobile,
				...
				/**
				 * Alias for data-role ns.selectors
				 * @property {Object} selectors
				 * @private
				 * @static
				 * @member ns.widget.mobile.Tokentextarea
				 ...
				 */
				classes = {
					uiTokentextarea: "tokentextarea",
					uiTokentextareaLabel: "tokentextarea-label",
					uiTokentextareaInput: "tokentextarea-input",
					uiTokentextareaInputVisible:
						"tokentextarea-input-visible",
					uiTokentextareaInputInvisible:
						"tokentextarea-input-invisible",
					uiinputText: "input-text",
					uiBodyS: "body-s",
					uiTokentextareaLinkBase: "tokentextarea-link-base",
					uiBtnBoxS: "btn-box-s",
					uiTokentextareaSblock: "tokentextarea-sblock",
					uiTokentextareaBlock: "tokentextarea-block",
					uiTokentextareaFocusout: "tokentextarea-focusout",
					uiTokentextareaFocusin: "tokentextarea-focusin",
					uiTokentextareaSpanBlock: "tokentextarea-span-block",
					uiTokentextareaInputArea: "tokentextarea-input-area",
					uiTokentextareaDesclabel: "tokentextarea-desclabel",
					uiTokentextareaInvisible: "tokentextarea-invisible"
				},
			...
			engine.defineWidget(
				"TokenTextarea",
				"[data-role='tokentextarea'], .tokentextarea",
				[
					"add",
					"remove",
					"length",
 ...
 *
 * ##Default selectors
 * In default all div or fieldset elements with _data-role=fieldcontain_ or data-role _.fieldcontain_ are changed to fieldcontain widget.
 *
 * ##HTML Examples
 *
 ...
 * For the sake of accessibility, the framework requires that all form elements be paired with a meaningful label. To hide labels in a way that leaves them visible to assistive technologies — for example, when letting an element's placeholder attribute serve as a label — apply the helper data-role hidden-accessible to the label itself:
 *
 *		@example
 *		<div data-role="fieldcontain">
 *			<label for="username" data-role="hidden-accessible">Username:</label>
 *			<input type="text" name="username" id="username" value="" placeholder="Username"/>
 *		</div>
 *
 * To hide labels within a field container and adjust the layout accordingly, add the data-role hide-label to the field container as in the following:
 *
 *		@example
 *		<div data-role="fieldcontain" data-role="hide-label">
 ...
 *
 * Because radio and checkbox buttons use the label to display the button text you can't use hidden-accessible in this case. However, the data-role hide-label can be used to hide the legend element:
 *
 *		@example
 *		<div data-role="fieldcontain" data-role="hide-label">
 *			<fieldset data-role="controlgroup">
 *				<legend>Agree to the terms:</legend>
 *				<input type="checkbox" name="checkbox-agree" id="checkbox-agree" data-role="custom" />
 ...
 *
 *
 * @data-role ns.widget.mobile.FieldContain
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
			...
			/**
			 * Dictionary for fieldcontain related css data-role names
			 * @property {Object} classes
			 * @member ns.widget.mobile.FieldContain
			 * @static
			 * @readonly
			 ...
			 *
			 *      @example
			 *      <div id="fieldcontain" data-role="fieldcontain" data-role="hide-label">
			 *          <label for="username">Username:</label>
			 *          <input type="text" name="username" id="username" value="" placeholder="Username"/>
			 *      </div>
			 *
 ...
 *
 * ##Default selectors
 * In default all elements with _data-role="gallery"_ or data-role _.gallery_ are changed to gallery widget.
 *
 * @data-role ns.widget.mobile.Gallery
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
			...
			var BaseWidget = ns.widget.mobile.BaseWidgetMobile,
				...
				engine = ns.engine,
				/**
				 * Alias for data-role {@link ns.util.selectors}
				 * @property {Object} selectors
				 * @member ns.widget.mobile.Gallery
				 * @private
				 */
			...
			/**
			 * Dictionary for gallery related css data-role names
			 * @property {Object} classes
			 * @member ns.widget.mobile.Gallery
			 * @static
			 * @readonly
			...
			Gallery.classes = {
				uiGallery: "gallery",
				uiGalleryContainer: "gallery-container",
				uiGalleryBg: "gallery-bg",
				uiContent: "content",
				uiHeader: "header",
				uiFooter: "footer",
			};
			...
			*/
			Gallery.prototype._build = function (element) {
				...
				for (i = 0, length = images.length; i < length; i++) {
					image = images[i];
					doms.wrapInHTML(image, "<div data-role='" + classes.uiGalleryBg + "'></div>");
				}
				if (element.children.length) {
					doms.wrapInHTML(element.children, "<div data-role='" + classes.uiGalleryContainer + "'></div>");
				} else {
					element.innerHTML = "<div data-role='" + classes.uiGalleryContainer + "'></div>";
				}
 ...
 *
 * In default all ListView elements with data-role _.fastscroll_ are changed to Tizen Web UI Fast Scroll
 *
 *		@example
 ...
 *		</script>
 *
 * @data-role ns.widget.mobile.FastScroll
 * @since 2.0
 */
(function (document, ns) {
	"use strict";
			...
			classes.uiFastscroll = "fastscroll";
			classes.uiFastscrollTarget = "fastscroll-target";
			classes.uiFastscrollPopup = "fastscroll-popup";
			classes.uiScrollbar = "scrollbar";
			classes.uiFastscrollHover = "fastscroll-hover";
			classes.uiFastscrollHoverFirstItem = "fastscroll-hover-first-item";
			classes.uiFastscrollHoverDown = "fastscroll-hover-down";
			...
			prototype._build = function (element) {
				var self = this,
					...
					page = selectors.getClosestByClass(element, "page"),
					scrollView = selectors.getClosestByClass(element, "scrollview-clip"),
					index;

				ns.warn("Deprecated widget 'FastScroll'. Please use instead 'IndexScrollbar'");

				indexElement.classList.add("indexscrollbar");
			...
			prototype._init = function () {
				...
				self._ui.scrollView = selectors.getClosestByClass(self.element, "scrollview-clip");
 ...
 *		</div>
 *
 * @data-role ns.widget.mobile.Controlgroup
 * @extends ns.widget.BaseWidget
 */
(function (document, ns) {
	"use strict";
				/**
			* Alias for data-role ns.widget.mobile.Controlgroup
			* @method Controlgroup
			...
			*/
			var Controlgroup = function () {
				...
				*/
				engine = ns.engine,
				/**
				* @property {Object} dom Alias for data-role ns.util.DOM
				* @member ns.widget.mobile.Controlgroup
				* @private
				* @static
				*/
			...
			/**
			 * Dictionary for Controlgroup related css data-role names
			 * @property {Object} classes
			 * @member ns.widget.mobile.Controlgroup
			 * @static
			 */
			Controlgroup.classes = {
				cornerAll: 'btn-corner-all',
				cornerTop: 'corner-top',
				cornerBottom: 'corner-bottom',
				cornerLeft: 'corner-left',
				cornerRight: 'corner-right',
				controlGroupLast: 'controlgroup-last',
				shadow: 'shadow',
				mini: 'mini',
				controlGroup: 'controlgroup',
				typePrefix: 'controlgroup-',
				controlGroupLabel: 'controlgroup-label',
				controlGroupControls: 'controlgroup-controls',
				controlGroupCornerAll: 'corner-all'
			};
			...
			*/
			Controlgroup.prototype._build = function (element) {
				...
				*/
				...
				dom.wrapInHTML(element.childNodes, "<div data-role='" + classes.controlGroupControls + "'></div>");
				...
				content = slice.call(element.querySelectorAll('.btn')).filter(function (item) {
					//@todo filter visiblity when excludeInvisible option is set
					return !item.classList.contains('slider-handle');
				});
				...
				flipClasses(slice.call(element.querySelectorAll('.btn-inner')), cornersClasses);
 ...
 *
 * @data-role ns.widget.mobile.Circularview
...
(function (document, ns) {
	"use strict";
			...
			engine.defineWidget(
				"Circularview",
				"[data-role='circularview'], .circularview", //@TODO ???
				[
					"getScrollPosition",
					"scrollTo",
					"centerTo",
 ...
 *
 * @data-role ns.widget.mobile.Datetimepicker
 * @extends ns.widget.mobile.BaseWidgetMobile
 */
(function (document, ns) {
	"use strict";
				...
				fieldRegexp = /datefield-([\w]*)/;

			Datetimepicker.prototype = new BaseWidget();

			Datetimepicker.classes = {
				uiBtnPicker: 'btn-picker',
				uiDatefield: 'datefield',
				uiDatefieldPrefix: 'datefield-',
				uiDatefieldSelected: 'datefield-selected',
				uiDatefieldPeriod: 'datefield-period',
				uiLink: 'link',
				uiDatetimepickerSelector: 'datetimepicker-selector',
				uiDatetimepicker: 'datetimepicker',
				uiInputText: 'input-text',
				uiBodyPrefix: 'body-',
				uiDivider1st: 'divider-1st',
				uiDivider2nd: 'divider-2nd',
				inClass: 'in',
				outClass: 'out',
				current: 'current'
			};
				...
				if (target.innerText !== text) {
					if (targetClassList.contains(classes.uiDatefieldSelected)) {
						...
						* @todo animation
						...
						removeClass("datefield-selected");
						});
						});
						*/
			...
			Datetimepicker.prototype._build = function (element) {
				...
				if (tagName === 'input') {
					...
					/*
					 * @todo change to data-role object
					 */
			...
			engine.defineWidget(
				...
				//"input[type='date'], input[type='datetime'], input[type='time'], [date-role='datetimepicker'], .datetimepicker",
