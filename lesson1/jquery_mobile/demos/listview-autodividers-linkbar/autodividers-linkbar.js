$.mobile.document.on( "pagecreate", "#demo-page", function(){
	var head = $( ".page-active [data-role='header']" );

	$.mobile.document.on( "click", "#sorter li", function() {
		var top,
			letter = $( this ).text(),
			divider = $( "#sortedList" ).find( "li.li-divider:contains(" + letter + ")" );
	...
	$( "#sorter li" ).hover(function() {
		$( this ).addClass( "btn" ).removeClass( "li-static" );
	}, function() {
		$( this ).removeClass( "btn" ).addClass( "li-static" );
	});
});
$( function(){
	$.mobile.window.on( "scroll", function( e ) {
		var headTop = $(window).scrollTop(),
			foot = $( ".page-active [data-role='footer']" ),
			head = $( ".page-active [data-role='header']" ),
...
$.mobile.document.on( "pageshow", "#demo-page", function() {
	var headerheight = $( ".page-active [data-role='header']" ).outerHeight();
