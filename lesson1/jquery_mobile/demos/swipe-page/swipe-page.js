...
$( document ).one( "pagecreate", ".demo-page", function() {
	...
	$( document ).on( "click", ".next", function() {
		var next = $( ".page-active" ).jqmData( "next" );
	...
	$( document ).on( "click", ".prev", function() {
		var prev = $( ".page-active" ).jqmData( "prev" );
...
$( document ).on( "pageshow", ".demo-page", function() {
	...
	// so first we remove the disabled data-role if it is there
	$( ".next.state-disabled, .prev.state-disabled" ).removeClass( "state-disabled" );

	if ( ! next ) {
		$( ".next" ).addClass( "state-disabled" );
	}
	if ( ! prev ) {
		$( ".prev" ).addClass( "state-disabled" );
	}
});
